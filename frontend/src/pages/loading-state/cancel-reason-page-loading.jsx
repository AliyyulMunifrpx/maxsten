...
export default function CancelReasonPageLoading() {
  return (
    <div className="w-full flex flex-col p-[16px] items-center h-full bg-[#1e1e1e] gap-[16px]">
      ...
      <div className="relative w-full lg:w-[60%] h-[40%] overflow-hidden  bg-white/5">
        {" "}
        <Shimmer />
      </div>
    </div>
