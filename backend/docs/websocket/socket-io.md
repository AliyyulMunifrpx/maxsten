...
_Catatan: Frontend tidak wajib mengirim ulang data identitas di setiap event. Setelah autentikasi berhasil, identitas disimpan oleh server di `socket.user`._
...
_(Guest tidak perlu login untuk menggunakan fitur antrean)._
